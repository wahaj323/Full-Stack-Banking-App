  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <p className="text-base-content/60">Sign in to your WJ Bank account</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-primary/5 rounded-lg p-4 space-y-2">
              <h3 className="font-semibold text-primary text-sm">Secure Banking:</h3>
      ...
      <AuthImagePattern
        ...
        subtitle="Access your account with advanced security features and enjoy seamless banking experience."
      />
    </div>
  );
};
